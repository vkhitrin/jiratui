...
from gojeera.constants import FULL_TEXT_SEARCH_DEFAULT_MINIMUM_TERM_LENGTH, LOGGER_NAME
...
from gojeera.widgets.attachments.attachments import IssueAttachmentsWidget
from gojeera.widgets.comments.comments import IssueCommentsWidget
from gojeera.widgets.create_work_item.screen import AddWorkItemScreen
from gojeera.widgets.filters import (
...
from gojeera.widgets.git_screen import GitScreen
from gojeera.widgets.related_work_items.related_issues import RelatedIssuesWidget
from gojeera.widgets.remote_links.links import IssueRemoteLinksWidget
from gojeera.widgets.search import (
    DataTableSearchInput,
    IssuesSearchResultsTable,
    SearchResultsContainer,
)
from gojeera.widgets.subtasks import IssueChildWorkItemsWidget
from gojeera.widgets.text_search import TextSearchScreen
from gojeera.widgets.work_item_details.details import IssueDetailsWidget
from gojeera.widgets.work_item_info.info import WorkItemInfoContainer
...
class MainScreen(Screen):
    ...
    async def fetch_projects(self) -> None:
        ...
        `--project-key` in the CLI command `gojeera ui --project-key` then the application will only fetch that
    ...
    async def fetch_issue(self, selected_work_item_key: str) -> None:
        ...
        `gojeera.widgets.search.IssuesSearchResultsTable`
        ...
        API's [get_issue](#gojeera.api_controller.controller.APIController.get_issue) method.
